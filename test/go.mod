...
require (
	...
	github.com/ishi-o/golem/connector/gitlab v0.3.0
	github.com/ishi-o/golem/connector/grafana v0.3.0
	github.com/ishi-o/golem/connector/webhook v0.3.0
	github.com/ishi-o/golem/core v1.0.0
	github.com/ishi-o/golem/sandbox/kubernetes v1.0.0
	github.com/ishi-o/golem/store/mongodb v1.0.0
	github.com/ishi-o/golem/store/redis v1.0.0
